            ...
            <div class="l-seniorPage">
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div class="c-sideNav">
                                    ...
                                    <div class="c-sideNav__area">
                                        <svg class="c-sideNav__english" viewBox="0 0 250 350">
                                            ...
                                            <text transform="translate(75 35.5)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;"><a
                                                    href="{{route('senior', ['area'=>'NORTHEAST'])}}"
                                                    class="text-none">美國東北部</a></text>
                                            <text transform="translate(75 75.1)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'WEST'])}}"
                                                    class="text-none">美國西部</a>
                                            </text>
                                            <text transform="translate(75 114.7)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'MIDWEST'])}}"
                                                    class="text-none">美國中西部</a>
                                            </text>
                                            <text transform="translate(75 154.2)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'SOUTH'])}}"
                                                    class="text-none">美國南部</a>
                                            </text>
                                            <text transform="translate(75 193.8)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'CANADA'])}}"
                                                    class="text-none">加拿大</a>
                                            </text>
                                            <text transform="translate(75 233.4)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'UK'])}}"
                                                    class="text-none">英國</a>
                                            </text>
                                            <text transform="translate(75 272.9)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'AUSTRALIA'])}}"
                                                    class="text-none">澳洲</a>
                                            </text>
                                            <text transform="translate(75 312.5)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'NEW ZEALAND'])}}"
                                                    class="text-none">紐西蘭</a>
                                            </text>
                                        ...
                                        <svg class="c-sideNav__eurp" viewBox="0 0 250 250">
                                            ...
                                            <text transform="translate(75 35.5)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'FRANCE'])}}"
                                                    class="text-none">法國</a>
                                            </text>
                                            <text transform="translate(75 75.1)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'GERMANY'])}}"
                                                    class="text-none">德國</a>
                                            </text>
                                            <text transform="translate(75 114.7)"
                                        ...
                                        <svg class="c-sideNav__asia" viewBox="0 0 250 420">
                                            ...
                                            <text transform="translate(75 35.5)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'INTERNATIONAL'])}}"
                                                    class="text-none">台灣｜國際學校</a>
                                            </text>
                                            <text transform="translate(75 75)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'HIGHSCHOOL'])}}"
                                                    class="text-none">台灣｜高中</a>
                                            </text>
                                            <text transform="translate(75 114.6)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['area'=>'COLLEGE'])}}"
                                                    class="text-none">台灣｜大學</a>
                                            </text>
                                            <text transform="translate(75 154.1)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'SINGAPORE'])}}"
                                                    class="text-none">新加坡</a>
                                            </text>
                                            <text transform="translate(75 193.7)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'JAPAN'])}}"
                                                    class="text-none">日本</a>
                                            </text>
                                            <text transform="translate(75 233.2)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'KOREA'])}}"
                                                    class="text-none">韓國</a>
                                            </text>
                                            ...
                                            <text transform="translate(75 312.3)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'HONG KONG'])}}"
                                                    class="text-none">香港</a>
                                            </text>
                                            <text transform="translate(75 351.9)"
                                                style="fill: #4c2a70; font-family: MyriadPro-Regular; font-size: 20px;">
                                                <a href="{{route('senior', ['country'=>'MACAU'])}}"
                                                    class="text-none">澳門</a>
                                            </text>
                        ...
                        <!-- desk ver -->
                        <div class="col-md-8 l-seniorPage__hideDeskVer">
                        ...
                        <!-- phone ver -->
                        <div class="col-md-8 p-0 l-seniorPage__hidePhoneVer">
                            <div class="l-seniorPage__content">
                                <div class="container-fluid">
                                    <div class="row gy-5">
                                        @forelse($users as $user)
