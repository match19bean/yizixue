...
<div class="l-yizixueFAQ">
    <div class="c-bannerCarousel__slide"
        style="background-image: url('{{asset('/uploads/'.$image->image_path)}}');">
        &nbsp;
    </div>
    <div class="l-yizixueFAQ__content container w-100 w-md-75">
        <div class="row pt-2 pt-md-5">
            <!-- 側邊欄 -->
            <div class="col-md-3">
                <ul class="nav nav-pills flex-column align-items-stretch" id="pills-tab" role="tablist">
                    @forelse($categories as $category)
                        <li class="mb-3" role="presentation">
                            <button class="nav-link w-100 o-faqTopic text-center 
                                    {{ $loop->first ? 'active' : '' }}" 
                    ...
                    @empty
                        <li><p class="text-center">暫無分類</p></li>
                    @endforelse
                </ul>
            </div>
                                    ...
                                    <button class="o-faqBtn w-100 text-start d-flex align-items-center p-3" 
                                        ...
                                        <div class="me-3">
                                            <svg width="30" height="30" viewBox="0 0 500 500">
                                                <circle cx="250" cy="250" r="250" fill="#6f4e7c"/>
                                                <path fill="white" 
